          ...
          {workspaces.map(
          	function(wp, key) {if(wp.name) {
          		...
          		return (
          			...
          			<CardActions>
          			<Button onClick={function(e){btnClick.handleOverview()}} size="small" color="primary">
          			OVERVIEW
          			</Button>
          			<Button onClick={function(e){btnClick.handleStartLabeling()}} size="small" color="primary">
          			START LABELING
          			</Button>
          			</CardActions>
          			</Card>
