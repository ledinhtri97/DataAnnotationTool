...
class GVMedicalOverlay extends React.Component {
    ...
    full_screen = () => {
        ...
        for(var i=0; i<dom_canvas.length; i++) {
            if(dom_canvas[i].id.indexOf(this.props.original_canvas_id) === -1) {
                dom_canvas[i].style.display = "none";
            }
        }
    }
        ...
        return (
            <div>
                <canvas className={classes.createjs_canvas} 
                    ...
                    onMouseDown={this.mouse_down}></canvas>
