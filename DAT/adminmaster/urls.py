...
from adminmaster.contributemanagement.views import ContributeView, contribute_view, contribute_accept, contribute_save
...
urlpatterns = [path('', TemplateView.as_view(
    ...
    path('contribute_view/<int:id_file>/',
         contribute_view, name='contribute_view'),
    path('contribute_accept/<int:id_file>/',
         contribute_accept, name='contribute_accept'),
    path('contribute_save/<int:id_file>/',
