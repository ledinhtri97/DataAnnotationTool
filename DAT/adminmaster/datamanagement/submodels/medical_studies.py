...
class MedicalStudiesModel(models.Model):
    ...
    studies_uid = models.CharField(max_length=100, blank=True, null=True, verbose_name="Studies UID")
    ...
    studies_instance_uid = models.CharField(max_length=100, blank=True, null=True, verbose_name="Studies Instance UID")
