...
# CELERY_RESULT_BACKEND = 'db+postgresql://scott:ledinhtri@localhost/mydatabase'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'hpcc.hcmut.edu.vn', '172.28.182.144', '172.28.183.160', '221.133.13.124']
